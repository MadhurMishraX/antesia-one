      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button 
            ...
            className="py-4 bg-white border border-gray-100 text-text-primary font-bold rounded-[20px] shadow-sm hover:bg-gray-50 transition-all flex items-center justify-center gap-2 text-sm"
          >
        ...
        <button 
          ...
          className="w-full py-4 bg-white border border-gray-100 text-text-primary font-bold rounded-[20px] shadow-sm hover:bg-gray-50 transition-all flex items-center justify-center gap-2 text-sm"
        >
            ...
            >
              <div className="bg-white p-4 rounded-[24px] border border-gray-100 shadow-sm space-y-4">
                <textarea 
                  ...
                  className={`w-full h-32 p-4 rounded-[16px] border-2 focus:outline-none transition-all resize-none text-sm font-medium ${
      ...
      <div className="space-y-4">
          ...
          {classHealth.length > 0 ? (
            classHealth.slice(0, 3).map((module) => (
              <div 
                ...
                className="p-5 flex items-center justify-between border-b border-gray-50 last:border-0 hover:bg-gray-50 transition-colors cursor-pointer group"
              >
        ...
        {classHealth.length > 3 && (
          <button 
            ...
            className="w-full py-4 bg-white border border-gray-100 text-text-primary font-bold rounded-[20px] shadow-sm hover:bg-gray-50 transition-all text-sm"
          >
            View All Modules
          </button>
        )}
